...
const CartDropdown = () => {
    ...
    return (
        <div className="cart-dropdown-container absolute w-[290px] h-[400px] flex flex-col top-[90px] right-[50px] bg-white border border-black z-50 items-center p-4">
            ...
            <button onClick={goToCheckoutHandler} className="w-50 h-10 shrink-0 bg-black text-white uppercase mt-4 flex items-center justify-center hover:bg-white hover:text-black cursor-pointer hover:border hover:border-black hover:border-solid">GO TO CHECKOUT</button>
        </div>
    )
}
